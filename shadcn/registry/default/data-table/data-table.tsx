...
import { dataTableFilterFn } from "./utils/filtering";
...
export function DataTable<TData>(props: DataTableProps<TData>) {
	...
	const table = useReactTable({
		...
		defaultColumn: {
			filterFn: dataTableFilterFn as FilterFn<TData>,
			...(enableColumnResizing ? { minSize: COLUMN_RESIZE_MIN_SIZE } : undefined),
		},
