...
function getActionsShadow(isScrolledToEnd: boolean) {
	const actionsBottomBorder = "inset 0 -1px 0 var(--color-border)";

	return isScrolledToEnd
		? actionsBottomBorder
		: `${actionsBottomBorder}, -4px 0 8px -2px rgba(0,0,0,0.1)`;
}
...
export function DataTableContent<TData>({
	...
	const actionsShadow = useMemo(() => getActionsShadow(isScrolledToEnd), [isScrolledToEnd]);
