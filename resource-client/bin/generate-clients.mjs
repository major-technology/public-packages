 ...
 * Types: postgresql | mssql | dynamodb | cosmosdb | snowflake | bigquery | neo4j | hubspot | linkedin | linkedinads | tiktokads | googlecalendar | gmail | googledrive | googlesearchconsole | googlesheets | outreach | custom | graphql | lambda | salesforce | s3 | slack | majorauth | googleanalytics | quickbooks | gong | clerk | stripe | fireflies | attio | dynamics | linear | ringcentral | zohodesk | zohoprojects | sqs | metamarketing
 *
 * Examples:
...
function addResource(resourceId, name, type, description, applicationId, framework, mode) {
  const validTypes = ['postgresql', 'mssql', 'dynamodb', 'cosmosdb', 'snowflake', 'bigquery', 'neo4j', 'hubspot', 'linkedin', 'linkedinads', 'tiktokads', 'googlecalendar', 'gmail', 'googledrive', 'googlesearchconsole', 'googlesheets', 'outreach', 'custom', 'graphql', 'lambda', 'salesforce', 's3', 'slack', 'majorauth', 'googleanalytics', 'quickbooks', 'gong', 'clerk', 'stripe', 'fireflies', 'attio', 'dynamics', 'linear', 'ringcentral', 'zohodesk', 'zohoprojects', 'sqs', 'metamarketing'];
